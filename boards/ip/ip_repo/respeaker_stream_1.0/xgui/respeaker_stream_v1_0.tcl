...
proc update_PARAM_VALUE.I2S_IN_WIDTH { PARAM_VALUE.I2S_IN_WIDTH } {
	# Procedure called to update I2S_IN_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.I2S_IN_WIDTH { PARAM_VALUE.I2S_IN_WIDTH } {
	# Procedure called to validate I2S_IN_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.I2S_IN_WIDTH { MODELPARAM_VALUE.I2S_IN_WIDTH PARAM_VALUE.I2S_IN_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.I2S_IN_WIDTH}] ${MODELPARAM_VALUE.I2S_IN_WIDTH}
}
